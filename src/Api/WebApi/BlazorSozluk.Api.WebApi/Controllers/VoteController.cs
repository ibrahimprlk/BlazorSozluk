using BlozorSozluk.Api.Application.Features.Commands.Entry.DeleteVote;
using BlozorSozluk.Api.Application.Features.Commands.EntryComment.DeleteVote;
using BlozorSozluk.Common.ViewModels.RequestModels;
using BlozorSozluk.Common.ViewModels;
using MediatR;
